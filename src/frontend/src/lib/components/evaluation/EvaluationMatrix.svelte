<script lang="ts">
  ...
  let totalWeight = $derived(evaluation.data.criteria.reduce((s, c) => s + c.weight, 0));
      ...
      {#each evaluation.data.criteria as criterion, ci}
        ...
        <tr class="row-group">
          <td class="cell-weight">
            ...
            {:else}
              <button
                class="weight-display weight-clickable"
              ...
              >
                ...
                <div class="weight-bar">
                  <div
                    ...
                    style="width: {(criterion.weight / 35) * 100}%"
                  ></div>
                </div>
              </button>
            {/if}
...
<div class="eval-progress">
  <div class="progress-item">
    ...
    <span class="progress-value"
      >{evaluation.progress.scores.filled} / {evaluation.progress.scores.total}</span
    >
    <div class="progress-bar">
      <div
        class="progress-bar-fill"
        style="width: {(evaluation.progress.scores.filled / evaluation.progress.scores.total) *
          100}%"
      ></div>
    </div>
  </div>
  <div class="progress-item">
    ...
    <span class="progress-value"
      >{evaluation.progress.notes.filled} / {evaluation.progress.notes.total}</span
    >
    <div class="progress-bar">
      <div
