	...
	<div class="panel">
		...
		<div class="supplier-nav">
			...
			<button
				...
				disabled={supplierIndex >= evaluation.data.suppliers.length - 1}
			>›</button>
		</div>
		...
		<div class="progress-strip">
			...
			<span class="progress-count">{justificationProgress.filled} / {justificationProgress.total}</span>
			<div class="progress-bar">
				<div
					class="progress-fill"
					style="width: {justificationProgress.total > 0 ? (justificationProgress.filled / justificationProgress.total) * 100 : 0}%"
				></div>
			</div>
		</div>
			...
			{#if criterion && supplier}
				...
				<div class="note-section note-overordnet">
					...
					<textarea
						...
						oninput={(e) => evaluation.setCriterionNote(criterion.id, supplier.id, e.currentTarget.value)}
