        ...
        <tr
          ...
          onkeydown={(e) => {
            if (e.key === 'Enter' || e.key === ' ') {
              e.preventDefault();
              qualification.selectSupplier(supplier.id);
            }
          }}
        >
          ...
          <td class="cell-espd">
            <button
              ...
              onclick={(e) => {
                e.stopPropagation();
                qualification.setEspd(requirement.id, supplier.id, !espd);
              }}
            >
              {espd ? '✓' : '—'}
            </button>
          ...
          <td class="cell-basis">
            <div class="basis-toggle">
              <button
                ...
                onclick={(e) => {
                  e.stopPropagation();
                  qualification.setBasis(requirement.id, supplier.id, 'own');
                }}>Egen</button
              >
              <button
                class="basis-btn"
                ...
                onclick={(e) => {
                  e.stopPropagation();
                  qualification.setBasis(requirement.id, supplier.id, 'supported');
                }}>Støtte</button
              >
            </div>
          </td>
              ...
              {#if addingFor === supplier.id}
                <div class="add-form">
                  ...
                  <input
                    ...
                    autofocus
                  />
                  <button class="add-confirm" onclick={() => handleAdd(supplier.id)}
                    >Legg til</button
                  >
...
<style>
  ...
  .row-entity:hover .entity-remove {
    opacity: 1;
  }
  .entity-remove:hover {
    color: var(--color-score-low);
